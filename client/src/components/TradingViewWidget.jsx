...
function TradingViewWidget() {
  ...
  const [height, setHeight] = useState(() => (typeof window !== 'undefined' && window.innerWidth < 640 ? 300 : 550));

  useEffect(() => {
    const handleResize = () => {
      setHeight(window.innerWidth < 640 ? 300 : 550);
    };
  ...
  return (
    <div
      ...
      style={{
        ...
        marginBottom: '24px',
        minHeight: height < 400 ? '200px' : '300px',
        maxHeight: 'none',
        overflow: 'hidden',
      }}
    >
